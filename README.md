To run the code first download the Samosa Toolbox (https://github.com/ragavvenkatesan/Convolutional-Neural-Networks) from my GitHub. Once the toolbox is downloaded, add the path to the code approrpiately.
